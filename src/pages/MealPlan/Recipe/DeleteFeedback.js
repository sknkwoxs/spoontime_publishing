export default function DeleteFeedback() {
  return (
    <>
      ...
      <section className="h-[120px] fixed top-[30%] bottom-0 left-0 right-0 p-4 bg-GreyScale-White rounded-lg mx-10 z-[1000] drop-shadow-popup">
        <p className="mb-6 Font16sb">식단 기록을 삭제할까요?</p>
